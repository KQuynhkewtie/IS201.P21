...
public class Them_HD extends BasePanel {
    ...
    private void initInfoForm() {
        ...
        btnChonKH.addActionListener(e -> hienThiThongTinKhachHang());
        add(btnChonKH);
    ...
    private void initDetailTable() {
        ...
        btnThemDong.addActionListener(e -> hienThiThongTinSanPham());
        add(btnThemDong);
    ...
    private void luuHoaDon() {
        ...
        if (hdBLL.XuLyLapHoaDon(hd, danhSachChiTiet)) {
