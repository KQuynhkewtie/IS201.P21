...
public class CapNhatTT_KH extends BasePanel {
        ...
        lblTTKhachhangLink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (kh != null) {
                    ...
                    ttctPage.HienThiThongTinChiTiet(kh.getHoTen(), kh.getMaKH(),  kh.getDiemTichLuy(),
        ...
        btnLuusua.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    boolean success = bllKhachhang.SuaThongTinKH(kh);

                    if (success) {
                        JOptionPane.showMessageDialog(null, "Cập nhật khách hàng thành công!");

                        TTCT_KH ttctPage = mainFrame.getPage("ttctkh", TTCT_KH.class);
                        ttctPage.HienThiThongTinChiTiet( kh.getMaKH(),kh.getHoTen(), kh.getDiemTichLuy(),
                                kh.getLoaiKhach(), kh.getSdt(), kh.getCCCD());
                        mainFrame.showPage("ttctkh");
                    } else {
    ...
    public void HienThiThongTinChiTiet(String maKH) {
        KhachHangDTO kh = bllKhachhang.getKhachHangById(maKH);
