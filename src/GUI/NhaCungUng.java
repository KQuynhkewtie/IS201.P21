...
public class NhaCungUng extends BasePanel {
                ...
                if (e.getClickCount() == 1) {
                    ...
                    if (row >= 0) {
                        ...
                        if (ncu != null) {
                            ...
                            ttctNCUPage.HienThiThongTinChiTiet(ncu.getMaNCU(),ncu.getTenNCU(),  ncu.getMaSoThue(), ncu.getDiaChi(),
    ...
    private void TimKiemNCU() {
        ...
        model.setRowCount(0);
        List<NhaCungUngDTO> list = bllncu.XuLyTraCuuNCU(keyword);
