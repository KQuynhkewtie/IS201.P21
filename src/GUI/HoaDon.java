...
public class HoaDon extends BasePanel {
    ...
    private void KiemTraTinhHopLe() {
        ...
        TimKiemHoaDon(keyword, fromDate, toDate, minAmount, maxAmount, trangThai);
    }
    ...
    private void TimKiemHoaDon(String keyword, String fromDate, String toDate,
        ...
        List<HoaDonDTO> danhSach = hdBLL.XuLyTraCuuHoaDon(
