...
public class PhieuNhapHang extends BasePanel {
    ...
    private void initSearchComponents() {
        ...
        btnSearch.addActionListener(e -> KiemTraTinhHopLe());
        add(btnSearch);
    ...
    private void KiemTraTinhHopLe() {
        ...
        TimKiemPhieuNhapHang(keyword, fromDate, toDate, minAmount, maxAmount);
    }

    private void HienThiDSPhieuNhapHang() {
        model.setRowCount(0);
        List<PhieuNhapHangDTO> danhSach = pnhBLL.layDanhSachPhieuNhapHang();
        displayData(danhSach);
    }

    private void TimKiemPhieuNhapHang(String keyword, String fromDate, String toDate,
                                      Double minAmount, Double maxAmount) {
        model.setRowCount(0);
        List<PhieuNhapHangDTO> danhSach = pnhBLL.XuLyTraCuuPhieuNhapHang(
