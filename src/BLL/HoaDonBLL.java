...
public class HoaDonBLL {
    ...
    public List<HoaDonDTO> XuLyTraCuuHoaDon(String keyword, String fromDate, String toDate,
    ...
    public List<ChiTietHoaDonDTO> layChiTietHoaDon(String maHoaDon) {
        return hdDAL.getTTChiTietHoaDon(maHoaDon);
    }

    public HoaDonDTO layHoaDonTheoMa(String maHoaDon) {
        return hdDAL.getThongTinHoaDon(maHoaDon);
    }
    ...
    public boolean XuLyLapHoaDon(HoaDonDTO hd, List<ChiTietHoaDonDTO> danhSachChiTiet) {
        try {
            ...
            boolean result = hdDAL.lapHoaDonVoiChiTiet(hd, danhSachChiTiet);
    ...
    public boolean SuaThongTinHDVoiChiTietHD(HoaDonDTO hd, List<ChiTietHoaDonDTO> danhSachChiTiet) {
        ...
        return hdDAL.SuaHoaDonVoiChiTietHD(hd, danhSachChiTiet);
    }

    private boolean kiemTraSanPhamTonTai(String maSP) {
        SanPhamDAL spDAL = new SanPhamDAL();
        return spDAL.getThongTinSanPham(maSP) != null;
    }

    public boolean huyHoaDon(String maHoaDon) {
        try {
            HoaDonDTO hd = hdDAL.getThongTinHoaDon(maHoaDon);
