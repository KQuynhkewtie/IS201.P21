...
public class PhieuNhapHangDAL {
    ...
    public List<ChiTietPhieuNhapHangDTO> getTTChiTietPhieuNhapHang(String maPNH) {
        return getTTCTPhieuNhapHang(maPNH, null);
    }
    ...
    public PhieuNhapHangDTO getTTPhieuNhapHang(String maPNH) {
    ...
    public boolean ThemPNH(PhieuNhapHangDTO pnh, Connection conn) {
    ...
    public boolean SuaPNH(PhieuNhapHangDTO pnh, Connection conn) throws SQLException {
    ...
    public List<ChiTietPhieuNhapHangDTO> getTTCTPhieuNhapHang(String maPNH, Connection conn) {
    ...
    public boolean SuaChiTietPNH(ChiTietPhieuNhapHangDTO ct, Connection conn) {
    ...
    public boolean ThemCTPNH(ChiTietPhieuNhapHangDTO ct, Connection conn) {
    ...
    public List<PhieuNhapHangDTO> timKiemPhieuNhapHang(String keyword, String fromDate, String toDate,
        ...
        if (toDate != null && !toDate.isEmpty()) {
            sql.append(" AND NGAYLAPPHIEU < TO_DATE(?, 'DD-MM-YYYY') + 1");
        }
