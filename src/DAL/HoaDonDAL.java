...
public class HoaDonDAL {
    ...
    public List<HoaDonDTO> timKiemHoaDon(String keyword, String fromDate, String toDate,
        ...
        if (toDate != null && !toDate.isEmpty()) {
            sql.append(" AND NGAYBAN < TO_DATE(?, 'DD-MM-YYYY') + 1");
        }
    ...
    public List<ChiTietHoaDonDTO> getTTChiTietHoaDon(String maHoaDon) {
    ...
    public HoaDonDTO getThongTinHoaDon(String maHoaDon) {
    ...
    public boolean lapHoaDonVoiChiTiet(HoaDonDTO hd, List<ChiTietHoaDonDTO> danhSachChiTiet) {
    ...
    public boolean SuaHoaDonVoiChiTietHD(HoaDonDTO hd, List<ChiTietHoaDonDTO> danhSachChiTiet) {
