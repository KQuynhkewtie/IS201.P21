...
public class NhaCungUngDAL {
    ...
    public NhaCungUngDTO getThongTinNCU(String maNCU) {
    ...
    public boolean ThemNCU(NhaCungUngDTO ncu) {
    ...
    public List<NhaCungUngDTO> TimKiemNCU(String keyword) {
    ...
    public boolean SuaNhaCungUng(NhaCungUngDTO ncu) {
    ...
    public boolean XoaNCU(String maNCU) {
